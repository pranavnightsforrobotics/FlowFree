...
# kinematics setup
k.defineRobot(75, 12, 100, 230, 10)
goalX = 0
goalY = 0
goalZ = -200
...
def redraw():
  ...
  if(abs(testPos[0] - goalX) < 0.1 and abs(testPos[1] - goalY) < 0.1 and abs(testPos[2] - goalZ) < 0.1):
    ...
    thigh1 = m.create_custom_pipe(1, base1Pos, knee1Pos)
    thigh2 = m.create_custom_pipe(1, base2Pos, knee2Pos)
    thigh3 = m.create_custom_pipe(1, base3Pos, knee3Pos)
    calf1 = m.create_custom_parallelogram(1, knee1Pos, bot1Pos, disPal1)
    calf2 = m.create_custom_parallelogram(1, knee2Pos, bot2Pos, disPal2)
    calf3 = m.create_custom_parallelogram(1, knee3Pos, bot3Pos, disPal3)
